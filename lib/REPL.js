!function(){
	...
	module.exports = new Class({
		...
		/**
		 * the warn() prints something yellow on the output stream
		 *
		 * @param <String>
		 */
		, warn: function(what) {
		...
		/**
		 * the error() method prints something red on the output stream
		 *
		 * @param <String>
		 */
		, error: function(what) {
		...
		/**
		 * the success() method prints something green on the output stream
		 *
		 * @param <String>
		 */
		, success: function(what) {
			this.outputStream.write(''+what.green);
